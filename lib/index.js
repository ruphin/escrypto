...
// (2^31)
const HARDENED_KEY_INDEX = 0x80000000;
// "Bitcoin seed"
const BITCOIN_SEED = new Uint8Array([66, 105, 116, 99, 111, 105, 110, 32, 115, 101, 101, 100]).buffer;
...
// Simple bufferUtil.mult() test
let b = new Uint8Array([0x01, 0x01, 0xff, 0xff]).buffer;
let a = new Uint8Array([0xff, 0x0f, 0xff]).buffer;
let c = bufferUtil.mult(a, b);
console.log(bufferUtil.toHex(a));
console.log(bufferUtil.toHex(b));
console.log(bufferUtil.toHex(c));
console.log(0x0101ffff * 0xff0fff);
console.log(eval(`0x${bufferUtil.toHex(c)}`));

console.log(bufferUtil.add(a, b));
